        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                @foreach ($products as $item)
                    <div class="hover:bg-orange-200 rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                           ...
                           <div class="mt-4 flex items-center justify-between gap-4">
                            ...
                            <div class="mt-4 flex items-center justify-between gap-4">
                                ...
                                <button 
                                        ...
                                        data-product-brand="{{ $item->brand->id }}"
                                        data-product-category="{{ $item->category->id }}"
                                        data-product-price="{{ $item->price }}"
                                        data-product-description="{{ $item->description }}"
                                        class="inline-flex items-center rounded-lg bg-primary-700 px-3 py-2.5 text-sm font-medium hover:bg-green-300 focus:outline-none focus:ring-4 bg-green-400" 
                                        type="button">
